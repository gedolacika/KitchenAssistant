...
public class FoodsAdapter extends RecyclerView.Adapter<FoodsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            fat = itemView.findViewById(R.id.cardview_food_details_fat);
            carbohydrate = itemView.findViewById(R.id.cardview_food_details_carbohydrate);
            protein = itemView.findViewById(R.id.cardview_food_details_protein);
            ...
            type = itemView.findViewById(R.id.cardview_food_quantity_title);
